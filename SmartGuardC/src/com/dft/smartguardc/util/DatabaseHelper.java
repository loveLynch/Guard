...
import com.dft.smartguardc.R;
import com.dft.smartguardc.config.CamMonitorParameter;
...
public class DatabaseHelper {
	...
	public static CamMonitorParameter query(Context context, int id)
			throws Exception {
		...
		try {
			...
			String[] columns = new String[] { "name", "ip", "port", "username",
					"password", "client_dir", "connect_type" };

			Cursor cursor = db.query("tb_cammonitor_configs", columns,
	...
	public static long update(Context context, String table,
	...
	public static int getCount(Context context, String table) throws Exception {
		...
		try {
			...
			Cursor cur = db.query(table, new String[] { "_id", "name" }, null,
					null, null, null, null);
			return cur.getCount();
		} catch (Exception e) {
			throw e;
	...
	public Cursor loadAllName() throws Exception {
		try {
			Cursor cur = db.query("tb_cammonitor_configs", new String[] {
					"_id", "name" }, null, null, null, null, "_id DESC");
			return cur;
		} catch (Exception e) {
			throw e;
		}
	...
	public Cursor query(int id) throws Exception {
		try {
			...
			String[] whereArgs = new String[] { String.valueOf(id) };
			Cursor cur = db.query("tb_cammonitor_configs", new String[] {
					"_id", "name", "ip", "port", "username", "password",
					"client_dir" }, whereClause, whereArgs, null, null,
					"_id DESC");
			return cur;
		} catch (Exception e) {
			throw e;
