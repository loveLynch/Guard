...
import com.dft.smartguardc.CamMonitorClient;
import com.dft.smartguardc.R;

/**
 *
 * 实现带editext的AlertDialog 按照此例子，可以实现任意格式的AlertDialog
 */
public class EditDialog extends AlertDialog implements
	...
	public EditDialog(Context context, String title, String value,
			OnDataSetListener callback) {
		super(context);
		mCallback = callback;
