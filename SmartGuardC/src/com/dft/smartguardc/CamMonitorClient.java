...
import com.dft.smartguardc.util.ActivtyUtil;
import com.dft.smartguardc.util.DatabaseHelper;
...
public class CamMonitorClient extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		try {
			...
			ActivtyUtil.showAlert(CamMonitorClient.this, "Error",
					e.getMessage(), "确定");
		}
	}
	...
	private View.OnClickListener btnConnectListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			try {
				...
				int id = cc.getInt(0);
				Intent intent = new Intent(CamMonitorClient.this,
						ServerAct.class);
	...
	private View.OnClickListener btnAddListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			Intent intent = new Intent(CamMonitorClient.this,
					CamMonitorConfigActivity.class);
	...
	private View.OnClickListener btnDeleteListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			try {
				...
				new AlertDialog.Builder(CamMonitorClient.this)
						.setTitle("确定删除吗？")
									...
									public void onClick(DialogInterface dialog,
										...
										try {
											DatabaseHelper.delete(
													CamMonitorClient.this, id);
											fillDataWithCursor();
											ActivtyUtil.openToast(
													CamMonitorClient.this,
													"删除成功!");
										} catch (Exception e) {
											Log.e(TAG, e.getMessage(), e);
											ActivtyUtil.openToast(
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (((keyCode == KeyEvent.KEYCODE_BACK) || (keyCode == KeyEvent.KEYCODE_HOME))
			...
			dialog_Exit(CamMonitorClient.this);
		}
		return false;
	...
	public static void dialog_Exit(Context context) {
		...
		builder.setTitle("Smart GuardC");
		builder.setIcon(R.drawable.iconc_ts);
